...
global data
accessToken = '<YOUR SPARK TOKEN HERE>'
meraki_key = "<YOUR MERAKI DASHBOARD AUTH HERE"
...
def add_user(org, user, header):
    payload = {"name": "DevNet Devvie", "email": "devviebot@gmail.com", "orgAccess": "full", "tags": []}
